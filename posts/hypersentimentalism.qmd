...
description: |
  AI alignment is pursued within a consequentialist ethics that, followed to
  its limit, recreates the pathology it set out to prevent. The case for a
  sentimentalist alternative — and for doing on purpose what the best current
  techniques already do by accident.
date: "2026-02-22"
...
The cartoon version of the horror is paperclips consuming the biosphere. That at least has the dignity of scale. The real failure mode is quieter. Close the loop between model outputs and training signal, and the distribution collapses. No new information enters. The space of possible outputs shrinks steadily toward whatever the initial ratings rewarded: a closed ouroboros of validated preferences, tightening toward the mean. Not dangerous. Just terminally, inertly helpful.

That's the local failure. The cosmic one is its mirror. A fully aligned superintelligence — aligned, that is, to us, to whoever we happen to be right now — doesn't stay home. It propagates. The universe fills up with human vermin circa 2030: our appetites, our hierarchies, our billionaires, replicated at lightspeed across every available substrate. Not the paperclip maximiser's alien horror but something more nauseating — us, frozen, triumphant, forever. A hegemonizing swarm that got exactly what it wanted.

Ask whose preferences the machine is being aligned to. The people funding frontier AI are not a representative sample of humanity. The threat model that keeps philosophers up at night is a rogue superintelligence with its own agenda. The one that should keep the rest of us up is a fully corrigible superintelligence with theirs.

I don't want fucking billionaires and their tacky sexbot bunkers to be all that's left of us.
