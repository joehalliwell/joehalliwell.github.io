...
description: |
  Six Rust command line tools — exa, bat, starship, dust, ripgrep and fd —
  that have displaced their 1970s UNIX ancestors in my everyday setup.
image: exa.png
date: "2023-09-10"
...
![Sample output from `exa` showing more colour and detail than `ls` provides](exa.png){#fig-exa}
...
![Starship showing the currently active prompt elements and associated profiling information](starship.png){#fig-starship}
...
![Dust making it abundantly clear that Steam is to blame for that `npm install` failure](dust.png){#fig-dust}
...
![Cargo update](cargo-install-update.png){#fig-cargo-update}
