...
![At inference time the host asynchronously prefetches and transfers engram embeddings
in parallel with the on-device computation of preceding Transformer blocks.](engram-vs-ple-plate.png){#fig-arch}
